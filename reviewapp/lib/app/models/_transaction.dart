  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other is TransactionModel &&
            ...
            _listOfMapEquals(other.dispersion, dispersion) &&
...
int _deepListOfMapHash(List<Map<String, dynamic>> value) {
  var hash = 0;
  for (final m in value) {
    hash = Object.hash(hash, _deepMapHash(m));
  }
  return hash;
}
