...
class UserList extends StatelessWidget {
  ...
  Widget _buildUserTile(BuildContext context, int index, bool isDark) {
    ...
    final isSelected = selectedUser == proc.id;
                        ...
                        children: [
                          ...
                          if (proc.meta?["signaturesMeta"] != null &&
                            ...
                            ListTile(
                              ...
                              subtitle: Text(
                                'Télécharger la procuration signée. Vous pouvez la prévisualiser avant de la télécharger.',
                                style: Theme.of(context).textTheme.bodySmall,
                              ),
                              onTap: () {
                                seeProcuration(
...
ListTile proccuration_action_sheet({
