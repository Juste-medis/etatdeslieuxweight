...
import 'package:mon_etatsdeslieux/app/core/helpers/fuctions/_get_image.dart';
import 'package:mon_etatsdeslieux/app/core/helpers/utils/utls.dart';
import 'package:mon_etatsdeslieux/app/core/static/model_keys.dart';
import 'package:mon_etatsdeslieux/app/core/static/static.dart';
      ...
      body: Center(
        child: Container(
          height: rf.ResponsiveValue<double?>(
            context,
            conditionalValues: [
              rf.Condition.largerThan(name: BreakpointName.SM.name, value: 100),
            ],
          ).value,
              ...
              Consumer<AppThemeProvider>(
                builder: (context, appTheme, child) {
                  ...
                  Future.delayed(const Duration(seconds: 2), () {
                    if (Jks.checkingAuth) return;
                    Jks.checkingAuth = true;
      ...
      if (mounted) {
        ...
        _controller = AnimationController(
          ...
          duration: const Duration(
            milliseconds: 3000,
          ), // Augmenté pour inclure le retour
        )..repeat();
      }
    });
  }
