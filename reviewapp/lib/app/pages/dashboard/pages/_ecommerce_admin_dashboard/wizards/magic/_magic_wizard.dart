...
import 'package:mon_etatsdeslieux/app/pages/dashboard/pages/_ecommerce_admin_dashboard/wizards/magic/analyse_image.dart';
import 'package:mon_etatsdeslieux/app/pages/dashboard/pages/_ecommerce_admin_dashboard/wizards/magic/magic_results.dart';
          ...
          if (res.status == true) {
            ...
            try {
              int actualOrder =
                  wizardState.inventoryofPieces
                      .firstWhere(
                        (element) => element.id == widget.piece,
            ...
            if (things.isEmpty) {
              await showFullScreenSuccessDialog(
                ...
                title:
                    "Aucun élément n'a été détecté sur les photos téléchargées.",
                message:
          ...
          body: Column(
            ...
            children: [
              Row(
                ...
                children: [
                  if (reviewState.currentStep != MagicStep.result)
                    IconButton(
              ...
              Expanded(
                child: PageView(
                  ...
                  children: [
                    ...
                    const KeepAliveWidget(child: MagicAnalyzing()),
                    KeepAliveWidget(
                      child: MagicResult(
                        piece: widget.piece,
                        afterDate: widget.afterDate,
                      ),
                    ),
                  ],
                ),
