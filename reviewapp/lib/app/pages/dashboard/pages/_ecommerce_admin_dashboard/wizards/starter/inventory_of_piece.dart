          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  "liste des pièces identifiées dans l'enceinte du bien".tr
                            ...
                            formContent: Column(
                              ...
                              children: [
                                editUserField(
                                  ...
                                  title: _lang.room,
                                  placeholder: "Saisisez le nom de la pièce".tr,
                                  onChanged: (text) {
                                    name = text;
                                  },
                                  required: true,
                ...
                if (wizardState.inventoryofPieces.isNotEmpty)
                  ReorderableListView(
                    primary: false,
                    ...
                    children: [
                      ...(wizardState.inventoryofPieces).asMap().entries.map((
                        entry,
                      ) {
                        final index = entry.key, item = entry.value;
                        return Column(
                          key: ValueKey('iop${item.order}-$index'),
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            InkWell(
                              onTap: () async {
