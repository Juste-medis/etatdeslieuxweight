...
class UserProfileUpdateWidget extends StatelessWidget {
  const UserProfileUpdateWidget({super.key, required this.textTheme});
    ...
    return Column(
      ...
      children: [
        editUserField(
          ...
          title: "Nom".tr,
          onChanged: (text) {
            appstate.updateFormValue('user_lastName', text);
          },
          required: true,
        ),
        editUserField(
          ...
          title: "Prénom".tr,
          onChanged: (text) {
            appstate.updateFormValue('user_firstName', text);
          },
          required: true,
        ),
        editUserField(
          ...
          title: "Email".tr,
          onChanged: (text) {
            appstate.updateFormValue('user_email', text);
          },
          required: true,
        ),
        editUserField(
          ...
          title: "Téléphone".tr,
          onChanged: (text) {
            appstate.updateFormValue('user_phone', text);
          },
          required: true,
        ),
        editUserField(
          textEditingController: TextEditingController(
            text:
                appstate.formValues['user_address'] ??
          ...
          type: "place",
          onChanged: (text) {
            appstate.updateFormValue('user_address', text);
          },
          required: true,
        ),
        editUserField(
          ...
          type: "date",
          onChanged: (text) {
            appstate.updateFormValue('user_birthDate', text);
          },
          required: true,
        ),
        editUserField(
          ...
          onChanged: (text) {
            appstate.updateFormValue('user_placeOfBirth', text);
          },
          required: true,
        ),
        editUserField(
          ...
          onChanged: (text) {
            appstate.updateFormValue('user_currentPassword', text);
          },
        ),
        editUserField(
          type: "password",
          ...
          onChanged: (text) {
            appstate.updateFormValue('user_newPassword', text);
          },
        ),
        editUserField(
          type: "password",
          ...
          onChanged: (text) {
            appstate.updateFormValue('user_confirmPassword', text);
          },
        ),
