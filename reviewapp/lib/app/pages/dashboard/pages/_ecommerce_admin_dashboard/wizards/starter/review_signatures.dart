                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        Text(
                          "Règlement de l'etat des lieux".tr
                              .capitalizeFirstLetter(),
                              ...
                              ? Column(
                                  ...
                                  children: [
                                    ...
                                    OutlinedButton.icon(
                                      ...
                                      label: Text(
                                        "Retour".tr.capitalizeFirstLetter(),
                                      ),
                                    ),
                                    16.height,
                                    OutlinedButton.icon(
                                      ...
                                      icon: const Icon(Icons.arrow_forward_ios),
                                      label: Text(
                                        "Aller vers l'état des lieux".tr
                                            .capitalizeFirstLetter(),
                                      ),
                                    ),
                                    16.height,
