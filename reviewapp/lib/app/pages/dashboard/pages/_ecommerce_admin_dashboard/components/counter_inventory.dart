          ...
          Column(
            ...
            children: [
              ...
              if (selectedcompteur.type != "electricity")
                editUserField(
                  title: "Relevé initial".tr,
                  type: "number",
                  placeholder: "${_lang.enterThe} ${_lang.heatingMode}",
                  initialvalue: selectedcompteur.initialReading ?? "",
                  rightwidget: (selectedcompteur.type == "cold_water" ||
                  ...
                  onChanged: (text) {
                    myprint(text);
                    selectedcompteur.initialReading = double.tryParse("$text");
                    _updateCompteur(wizardState, selectedcompteur);
                  },
                ),
              if (selectedcompteur.type != "electricity")
                editUserField(
                  title: "Relevé actuel".tr,
                  type: "number",
                  rightwidget: (selectedcompteur.type == "cold_water" ||
                          selectedcompteur.type == "hot_water" ||
                          selectedcompteur.type == "gas")
                      ...
                      : selectedcompteur.type == "electricity"
                          ...
                          : selectedcompteur.type == "energy"
                              ? "kWh"
                              : " ",
                  initialvalue: selectedcompteur.currentReading ?? "",
                  onChanged: (text) {
                    selectedcompteur.currentReading = double.parse("$text");
                    _updateCompteur(wizardState, selectedcompteur);
                  },
                ),
              30.height,
                  ...
                  children: [
                    Expanded(
                      child: editUserField(
                        ...
                        onChanged: (text) {
                          selectedcompteur.initialReadingHp =
                    ...
                    Expanded(
                      child: editUserField(
                        ...
                        onChanged: (text) {
                          selectedcompteur.initialReadingHc =
                              double.tryParse("$text");
                          _updateCompteur(wizardState, selectedcompteur);
                        },
                      ),
                  ...
                  children: [
                    Expanded(
                      child: editUserField(
                        ...
                        type: "number",
                        rightwidget: "kWh",
                        placeholder: "Heures pleines actuel",
                        initialvalue: selectedcompteur.currentReadingHp ?? "",
                        onChanged: (text) {
                          selectedcompteur.currentReadingHp =
                              double.parse("$text");
                          _updateCompteur(wizardState, selectedcompteur);
                        },
                      ),
                    ...
                    Expanded(
                      child: editUserField(
                        ...
                        type: "number",
                        rightwidget: "kWh",
                        placeholder: "Heures creuses actuel",
                        initialvalue: selectedcompteur.currentReadingHc ?? "",
                        onChanged: (text) {
                          selectedcompteur.currentReadingHc =
                              double.parse("$text");
                          _updateCompteur(wizardState, selectedcompteur);
                        },
                      ),
                ...
                onPressed: () async {
                  sourceSelect(
                      ...
                      callback: (croppedFile) async {
                        await uploadFile(croppedFile, thing: selectedcompteur,
                            cb: (photolist) {
                ...
                SizedBox(
                  ...
                  child: GridView.count(
                    ...
                    children: List.generate(
                      selectedcompteur.photos!.length,
                      (index) {
              ...
              ElevatedButton.icon(
                ...
                onPressed: () async {
                  ...
                  if (confirmed ?? false) {
                    wizardState.domaine.compteurs.removeWhere((element) =>
