...
class ReviewPreview extends StatelessWidget {
                      ...
                      children: [
                        ...
                        inventoryAddButton(context,
                            ...
                            onPressed: reviewState.isLoading
                                ? null
                                : () async {
                                    await _submitSignatures(reviewState,
  ...
  Widget build(BuildContext context) {
    ...
    try {
      seconddocumentUrl = reviewState.data[
    ...
    try {
      ...
      await grifferefiew(payload).then((res) async {
        if (res.status == true) {
          ...
          Jks.pSp!.clear();
          Jks.griffes!.clear();
          reviewState.updateThereview(reviewState.editingReview!, "griffe",
  ...
  Widget _buildPdfPreview(context, theme,
            ...
            Positioned.fill(
              child: Container(
                ...
                child: SfPdfViewer.network(
                  ...
                  horizontal: (reviewState.editingReview!.status == "completed"
                      ? 10
                      : 50)),
            ),
            Positioned(
