      ...
      child: DropdownButton2(
        ...
        onChanged: (value) async {
          ...
          if (value == lang.signout) {
            // Execute all imperative actions and check if they all return true
            bool allActionsSucceeded = true;
            for (var entry in Jks.imperativeActions.entries) {
            ...
            if (!allActionsSucceeded) {
              return; // Stop execution if any action failed or returned false
            }
