...
class _ProccurationDashboardState extends State<ProccurationDashboard> {
  ...
  Widget build(BuildContext context) {
    try {
      ...
      final isfromNewProc =
          widget.proccuration.source == 'saved' ||
      ...
      var proc = isfromNewProc
          ...
          : proccurationState.proccurations.firstWhere(
              ...
              orElse: () => widget.proccuration,
            );
      final theAutors = [
        ...proc.owners!,
        proc.exitenants![0],
        proc.entrantenants![0],
      ];
      var me = proc.me();
      var haveSigned = proccurationState.editingProccuration!.haveSigned(
        author: me,
      );
      var isTheAuthor = proc.isTheAutor();
      ...
      if (proc.meta?["signatures"] != null &&
        ...
        Jks.canEditReview =
            proccurationState.editingProccuration?.status ?? "draft";
      }
      ...
      var moreOverviewData = [
        (
          ...
          () {
            ...
            wizardState.prefillProccuration(proc);
      ...
      return Consumer<AppThemeProvider>(
        builder: (context, lang, child) {
          ...
          return Scaffold(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (proc.meta?["signatures"] != null &&
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                            color: _theme.colorScheme.outline.withAlpha(100),
                          ),
                        ),
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            ...
                            ...proc.meta!["signatures"].keys.map((key) {
                              ...
                              var signatureData = proc.meta!["signatures"][key];
                              var signatureDate = formatDate(
                    ...
                    Row(
                      ...
                      children: [
                        if (proc.completedreview == true)
                          OutlinedButton.icon(
                            onPressed: proccurationState.isLoading
                                ? null
                                : () async {
                                    proccurationState.setloading(true);
                                    await getUnityReview(
                                          proc.id,
                        ...
                        FloatingActionButton(
                          ...
                          backgroundColor: _theme.colorScheme.primary,
                          child: Icon(
                            (haveSigned || proc.status == "completed")
            ...
            bottomNavigationBar: haveSigned
                ? null
                : Padding(
                    padding: const EdgeInsets.all(16.0),
                    child: Row(
                      mainAxisAlignment: isTheAuthor
                          ? MainAxisAlignment.center
                          : MainAxisAlignment.spaceBetween,
                      children: [
                        if (!isTheAuthor) Spacer(),
                        if (isTheAuthor)
                          TextButton.icon(
                            onPressed: proccurationState.isLoading
                                ? null
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            if (_hasContactInfo()) ...[8.height, _buildContactInfo(_theme)],
            12.height,
            SizedBox(
  ...
  Widget _buildStatusContainer(ThemeData theme) {
    if (hasSigned && signatureDate != null) {
      return Container(
        ...
        decoration: BoxDecoration(
          color: const Color(0xff03BB9A).withAlpha(25),
          border: Border.all(color: const Color(0xff03BB9A)),
          borderRadius: BorderRadius.circular(4),
        ),
        child: Row(
          mainAxisSize: MainAxisSize.min,
          children: [
            Icon(Icons.check_circle, size: 16, color: const Color(0xff03BB9A)),
            6.width,
            Expanded(
              child: Text(
                "Signé le $signatureDate".tr,
...
class UserInfoDialog extends StatelessWidget {
  ...
  const UserInfoDialog({super.key, required this.user, this.proccuration});
            ...
            Row(
              children: [
                CircleAvatar(
                  ...
                  child: Icon(Icons.person, color: _theme.colorScheme.primary),
                ),
                12.width,
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      if (user.denomination?.isNotEmpty == true) ...[
                        ...
                        Text(
                          user.denomination!,
                          style: _theme.textTheme.bodyMedium?.copyWith(
                            color: _theme.colorScheme.onSurface.withOpacity(
                              0.6,
                            ),
                          ),
                          overflow: TextOverflow.ellipsis,
    ...
    onConsumption: () {
      Jks.paymentState
          .useOneCredit({
            'type': "procurement",
            "procuration_id":
                Jks.wizardState.formValues['procurationId'] ?? proc.id,
          })
          .then((val) {
            ...
            var newpro = proc.copyWith(credited: true);
            if (Jks.proccurationState.proccurations.isNotEmpty) {
              int index = Jks.proccurationState.proccurations.indexWhere(
                (element) => element.id == proc.id,
              );
