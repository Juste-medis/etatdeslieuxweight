                  ...
                  ReorderableListView(
                    ...
                    onReorder: (oldIndex, newIndex) {
                      ...
                      for (
                        ...
                        wizardState.domaine.compteurs[i] = wizardState
                            .domaine
                            .compteurs[i]
                            .copyWith(order: i + 1);
                      }
                    ...
                    children: [
                      ...(wizardState.domaine.compteurs).asMap().entries.map((
                        entry,
                      ) {
                      ...
                      if (wizardState.domaine.compteurs.isEmpty)
                        Center(
