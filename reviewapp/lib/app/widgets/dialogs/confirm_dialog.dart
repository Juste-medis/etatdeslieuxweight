...
Future<bool?> showAwesomeConfirmDialog({
                  ...
                  Column(
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: FilledButton(
                          onPressed: () {
                            onpositiveClicked = true;

                            if (persistantOnPositive != null) {
                              persistantOnPositive();
                            } else {
                              if (onpositive != null) {
                                onpositive();
  ...
  return result ?? (onpositiveClicked);
}
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: _theme.textTheme.bodyLarge?.copyWith(
                        color: _theme.textTheme.bodyLarge?.color?.withOpacity(
                          0.75,
                        ),
                      ),
                    ),
...
class FullScreenLoadingDialog extends StatefulWidget {
  ...
  @override
  State<FullScreenLoadingDialog> createState() =>
