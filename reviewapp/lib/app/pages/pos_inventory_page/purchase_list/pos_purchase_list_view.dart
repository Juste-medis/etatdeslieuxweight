...
import '../demo_data/demo_data_purchase_list.dart';
// 🌎 Project imports:
import '../../../../generated/l10n.dart' as l;

class POSPurchaseListView extends StatefulWidget {
  const POSPurchaseListView({super.key});
...
class _POSPurchaseListViewState extends State<POSPurchaseListView> {
  ...
  late List<DemoDataPurchase> _filteredData;
  final ScrollController _scrollController = ScrollController();
  final List<DemoDataPurchase> users = AllPurchase.allPurchase;
  int _currentPage = 0;
  int _rowsPerPage = 10;
  String _searchQuery = '';
  ...
  List<DemoDataPurchase> get _currentPageData {
  ...
  ElevatedButton addPurchase(TextTheme textTheme, BuildContext context) {
