...
class _BorderOverviewCardState extends State<BorderOverviewCard> {
  ...
  Widget build(BuildContext context) {
    ...
    final _border =
        widget.border ??
        const Border(top: BorderSide(color: Colors.amber, width: 6));
  ...
  Widget _buildIcon(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(color: widget.iconBackgroundColor),
  ...
  Widget _buildContent(BuildContext context, bool isVerticalCard) {
    return Column(
      mainAxisSize: MainAxisSize.min,
      crossAxisAlignment: isVerticalCard
