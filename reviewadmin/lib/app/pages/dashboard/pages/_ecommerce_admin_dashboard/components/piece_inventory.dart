                ...
                customHeader: Column(
                  ...
                  children: [
                    ...
                    inventoryAddButton(
                      ...
                      onPressed: Jks.reviewState.editingReview?.status ==
                              "completed"
                          ? null
                          : () async {
          ...
          Column(
            ...
            children: [
              ...
              inventoryAddButton(
                ...
                onPressed: Jks.reviewState.editingReview?.status == "completed"
                    ? null
                    : () async {
                        sourceSelect(
                            context: context,
                            callback: (croppedFile) async {
                              await uploadFile(croppedFile,
                                  thing: selectedPiece, cb: (photolist) {
                    ...
                    : () async {
                        ...
                        if (confirmed ?? false) {
                          wizardState.updateInventory(
                            iop: wizardState.inventoryofPieces
                                .where((piece) =>
                                    piece.order != selectedPiece.order)
                                .toList(),
                          );
                          Jks.savereviewStep();
                          context.popRoute();
