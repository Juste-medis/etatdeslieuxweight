...
class _FaqViewState extends State<FaqView> {
          ...
          itemBuilder: (context, index) {
            if (index == termsList.length) {
              return OutlinedButton(
                onPressed: () {
                  commonLaunchUrl(
                    "https://adidomedis.cloud/jatai-etat-des-lieux-aide",
                  );
                },
  ...
  List<Map<String, String>> get termsList => [
    ...
    {
      'title':
          "L'état des lieux réalisé via Jatai a-t-il une valeur légale ?".tr,
      'description':
    ...
    {
      'title':
          "Et si j'ai besoin d'aide ou de conseils pendant le processus ?".tr,
      'description':
