...
const editEvent = async (req, res) => {
    ...
    try {
        ...
        await eventModel.findOneAndUpdate(
            ...
            {
                $set: {
                    avatar, event: name, categoryId, organizerId, sponsorId, date, lastdate, time, price, tax, totalSeat,
        ...
        return res.redirect(`/event-details?id=${id}`);
...
const addImage = async (req, res) => {
    ...
    try {
        ...
        return res.redirect(`/gallery?id=${id}`);
