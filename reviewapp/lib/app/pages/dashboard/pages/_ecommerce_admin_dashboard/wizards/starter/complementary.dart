              ...
              children: [
                ...
                if (review != null)
                  backbutton(
                    ...
                    title: Text(
                      "Informations complémentaires et caractéristiques du logement"
                ...
                Text(
                  "Caractéristiques du logement".tr.capitalizeFirstLetter(),
                  style: theme.textTheme.titleLarge?.copyWith(
                ...
                Column(
                  ...
                  children: [
                    editUserField(
                      ...
                      initialvalue: wizardState.domaine.heatingType ?? "-",
                      placeholder: "${_lang.enterThe} ${_lang.heatingType}",
                      type: "select",
                      onChanged: (text) {
                    ...
                    editUserField(
                      ...
                      type: "select",
                      items: heatingmODes,
                      initialvalue: wizardState.domaine.heatingMode ?? "-",
                    ...
                    editUserField(
                      ...
                      type: "select",
                      initialvalue: wizardState.domaine.hotWaterType ?? "-",
                      items: heatingTypes,
                      placeholder: "${_lang.enterThe} ${_lang.hotWaterType}",
                      onChanged: (text) {
                    ...
                    editUserField(
                      ...
                      initialvalue: wizardState.domaine.hotWaterMode ?? "-",
                      placeholder: "${_lang.enterThe} ${_lang.hotWaterMode}",
                      onChanged: (text) {
