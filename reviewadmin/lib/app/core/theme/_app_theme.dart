...
abstract class AcnooAppTheme {
  ...
  static ThemeData kLightTheme() {
    ...
    return _baseTheme.copyWith(
      ...
      inputDecorationTheme: _inputDecorationTheme(theme: _baseTheme).copyWith(
        fillColor: AcnooAppColors.kWhiteColor,
        filled: true,
      ),
  ...
  static InputDecorationTheme _inputDecorationTheme({
    ...
    return InputDecorationTheme(
      ...
      isDense: true,
      isCollapsed: true,
      fillColor: _isDark ? AcnooAppColors.kDark2 : AcnooAppColors.kWhiteColor,
      filled: true,
