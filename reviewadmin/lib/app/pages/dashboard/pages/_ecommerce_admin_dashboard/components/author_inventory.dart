  ...
  Widget build(BuildContext context) {
    ...
    final isPhysical = reviewState.editingAuthor.type == "physique",
        addressifier = editUserField(
          ...
          title: isPhysical
              ? "Adresse de l'auteur".tr
              : "Adresse de la société".tr,
          type: "place",
          onChanged: (text) {
            reviewState.editingAuthor.address = text;
            reviewState.seteditingAuthor(reviewState.editingAuthor,
                liveupdate: false);
          },
          required: true,
        );
                        ...
                        children: [
                          ...
                          editUserField(
                            textEditingController: TextEditingController(
                                text:
                                    reviewState.editingAuthor.type == "physique"
                                        ? reviewState.editingAuthor.placeOfBirth
                                        : reviewState.editingAuthor.representant
                                                ?.placeOfBirth ??
                                            ""),
                              ...
                              children: [
                                ...
                                editUserField(
                                  ...
                                  onChanged: (text) {
                                    ...
                                    if (wizardState.mandataire?.type ==
                                        "morale") {
                                ...
                                editUserField(
                                  ...
                                  onChanged: (text) {
                                    ...
                                    if (wizardState.mandataire?.type ==
                                        "morale") {
                                      wizardState
                                          .mandataire?.representant?.dob = text;
                                    }
