...
class ProccurationPreview extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var maindocumentUrl = proccurationState.data[
        "${myposition == "owner" ? ownerpositions[0] : myposition}_pdfPath"];
    var secondocumentUrl = proccurationState.data[
    ...
    Future<void> _submitSignatures(
        ProccurationProvider proccurationstate, InventoryAuthor me,
        {context}) async {
      ...
      final confirmed = await showAwesomeConfirmDialog(
        ...
        description:
            "Si vous signez, vous acceptez que la proccuration est considérée comme finalisé et ne peut plus être modifié."
                .tr,
      );
      if (!(confirmed ?? false)) {
        return;
      ...
      try {
        ...
        payload["tenantSignatures"]["${me.id}"] =
            base64Encode(Jks.griffes!["${me.id}"]);
        await griffeprocuration(payload).then((res) async {
          if (res.status == true) {
            proccurationState.seteditingProcuration(proccurationState
                .editingProccuration!
                .copyWith(meta: res.data["meta"]));
            ...
            await showFullScreenSuccessDialog(
              Jks.context!,
              title: "Vous avez signé la proccuration avec succès".tr,
              message:
                  "La proccuration est maintenant finalisé et ne peut plus être modifiée."
                      .tr,
              okText: 'Continuer',
              onOk: () {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          "Prévisualisation de la proccuration".tr.capitalizeFirstLetter(),
      ...
      persistentFooterButtons: proccurationState.editingProccuration!.status ==
              "completed"
          ? []
          : [
              Row(
                ...
                children: [
                  Flexible(
                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          TextSpan(
                            ...
                            recognizer: TapGestureRecognizer()
                              ..onTap = proccurationState.isLoading
                                  ? null
                                  : () async {
                                      var docurl = documentUrl(maindocumentUrl);
                                      downloadWithHttp(
                                        docurl!,
                                        fileName: Jks.dowloadreviewName!,
                                      );
                        ...
                        Text(
                            ("La proccuration est complete et prête à être signée")
                                .tr
                  ...
                  inventoryAddButton(
                    context,
                    title: "Signer la proccuration".tr,
                    isLoading: proccurationState.isLoading,
                    icon: Icons.edit,
                    onPressed: proccurationState.isLoading
                        ? null
              ...
              customHeader: Column(
                ...
                children: [
                  if (proccurationState.isLoading)
                    ...
                    if (myposition == "owner")
                      Text(
                        "Procuration pour les Sortants : ${maindocumentUrl}"
                            .tr
                            .capitalizeFirstLetter(),
                        style: theme.textTheme.titleLarge?.copyWith(
                          fontSize: 16,
                    ...
                    if (maindocumentUrl != null)
                      _buildPdfPreview(context, theme,
                          ...
                          typename:
                              myposition == "owner" ? "sortant" : myposition),
                    if (myposition == "owner") ...[
                      20.height,
                      Text(
                        "Proccuration pour les Entrants : "
                            .tr
                            .capitalizeFirstLetter(),
                        style: theme.textTheme.titleLarge?.copyWith(
                          fontSize: 16,
  ...
  Widget _buildPdfPreview(BuildContext context, theme,
        ...
        children: [
          Container(
            ...
            child: SfPdfViewer.network(
              ...
              onTap: (details) => _seepreview(false),
            ),
          ).paddingSymmetric(
              horizontal:
                  (proccurationState.editingProccuration!.status == "completed"
