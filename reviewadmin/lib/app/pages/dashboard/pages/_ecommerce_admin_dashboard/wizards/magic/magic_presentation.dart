        ...
        children: [
          ...
          ResponsiveGridCol(
            ...
            child: _buildSteRow(
              ...
              "Jataix utilise l'IA pour identifier les éléments présents dans la pièce.",
            ).paddingOnly(bottom: 16),
          ),
          ResponsiveGridCol(
            xs: 12,
...
Widget buildMagicCTASection(BuildContext context,
    {required VoidCallback? onsTart, title = "Commencer l'analyse"}) {
  return Column(
