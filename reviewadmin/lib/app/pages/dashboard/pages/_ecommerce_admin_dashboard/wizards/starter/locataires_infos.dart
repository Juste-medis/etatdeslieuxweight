                      ...
                      children: [
                        ...
                        ...wizardState.inventoryLocatairesSortant
                          ...
                          final isPhysical = wizardState
                                      .inventoryLocatairesSortant[index].type ==
                                  "physique",
                          ...
                          return Column(
                            ...
                            children: [
                              ...
                              editUserField(
                                ...
                                initialvalue: wizardState
                                    .inventoryLocatairesSortant[index].phone,
                                type: "phone",
                                required: true,
                              ),
                              editUserField(
                              ...
                              editUserField(
                                ...
                                initialvalue: wizardState
                                    .inventoryLocatairesSortant[index].email,
                                onChanged: (text) {
                                  wizardState.inventoryLocatairesSortant[index]
                                      .email = text;
                                  if (wizardState
                            ...
                            return Column(
                              ...
                              children: [
                                ...
                                editUserField(
                                  ...
                                  type: "phone",
                                  initialvalue: wizardState
                                      .inventoryLocatairesEntrants[index].phone,
                                  required: true,
                                ),
                                if (isPhysical)
                                  editUserField(
                                ...
                                editUserField(
                                  title: _lang.emailTenant,
                                  initialvalue: wizardState
                                      .inventoryLocatairesEntrants[index].email,
                                  onChanged: (text) {
                                    wizardState
                                        .inventoryLocatairesEntrants[index]
                                        .email = text;
